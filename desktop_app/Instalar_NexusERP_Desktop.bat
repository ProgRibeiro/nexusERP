@echo off
:: ===============================================================================
:: NEXUS ERP v2.0 — INSTALADOR AUTOMÁTICO PADRÃO 1-CLIQUE (WINDOWS NATIVO)
:: ===============================================================================
...
chcp 65001 >nul
title Instalador Nexus ERP Enterprise Desktop v2.0

echo.
echo  ================================================================
echo  🚀 INSTALADOR AUTOMÁTICO NEXUS ERP ENTERPRISE DESKTOP v2.0
echo  ================================================================
echo.
...
echo  • Conexão pré-configurada: https://erp.oprestador.tech
echo.
