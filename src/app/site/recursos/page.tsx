  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-5 py-16">
      ...
      <p className="mt-4 max-w-3xl text-sm leading-7 text-zinc-300">
        O Nexus integra CRM, orçamento, execução, financeiro, estoque, relatórios e NFS-e em uma experiência unificada de produtividade.
      </p>
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        {[
          ...
          <div key={item} className="rounded-2xl border border-white/10 bg-white/[.03] p-5 text-sm font-semibold text-zinc-200">
            {item}
          </div>
        ))}
      </div>
